...
parser.add_argument('--data.n_workers', type=int, default=0, help="number of workers for dataloader (default: 0)")
...
parser.add_argument('--speech.csv_file', type=str, default=None, metavar='FILE',
...
parser.add_argument('--speech.num_frames', type=int, default=-1, help='number of frames to read from input')
